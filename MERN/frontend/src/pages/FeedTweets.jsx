    ...
    <>
      ...
      <section className="w-full py-1 px-3 pb-[70px] sm:ml-[70px] sm:pb-0 lg:ml-0 bg-white dark:bg-black  ">
        <form
          ...
          className="mt-2 dark:border-[#ae7aff] border-red-200 border rounded  pb-2"
        >
          <textarea
            {...register("tweet")}
          ...
          <div className="flex items-center justify-end gap-x-3 px-3">
            ...
            <button
              type="submit"
              className="dark:bg-[#ae7aff] bg-red-500 dark:text-black text-white rounded px-3 py-2 drop-shadow-sm font-semibold dark:focus:bg-[#602db2] focus:bg-red-700 "
            >
              Send
            </button>
          </div>
