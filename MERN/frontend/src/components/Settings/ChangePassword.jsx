      ...
      <div className="w-full sm:w-1/2 lg:w-2/3">
        <form onSubmit={handleSaveChange} className="rounded-lg border">
          <div className="flex flex-wrap gap-y-4 p-4">
            <div className="w-full">
              ...
              <input
                ...
                name="oldPassword"
                onChange={(e) =>
                  setData((pre) => ({ ...pre, oldPassword: e.target.value }))
                }
            ...
            <div className="w-full">
              ...
              <input
                ...
                name="confPassword"
                onChange={(e) =>
                  setData((pre) => ({ ...pre, confPassword: e.target.value }))
                }
          ...
          <div className="flex items-center justify-end gap-4 p-4">
            ...
            <button
              type="submit"
              className="inline-block rounded dark:bg-[#ae7aff] bg-green-600 text-white dark:text-black px-3 py-1.5 "
            >
              Update Password
            </button>
          </div>
