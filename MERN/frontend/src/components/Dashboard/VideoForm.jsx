    ...
    <div>
      {showPopup &&
        createPortal(
          <dialog
            ref={dialog}
            className="h-fit backdrop:backdrop-blur-lg lg:w-[40%] md:w-2/3 rounded "
          >
            <UploadingVideo
              ref={uploadingDialog}
              abort={handleAbort}
            ...
            <div className=" dark:bg-black/85 p-2 sm:p-2 dark:text-white bg-[#fff8f8] text-black rounded ">
              <form
                ...
                className="h-fit border  bg-white dark:bg-[#121212] rounded "
              >
                {/* Close Buttons */}
                ...
                <div className="mx-auto flex w-full max-w-3xl flex-col gap-y-2 md:gap-y-3 p-4">
                  ...
                  <div className="w-full">
                    <label
                      htmlFor="thumbnail"
                      className="mb-1 inline-block hover:cursor-pointer"
                    >
                      Thumbnail
