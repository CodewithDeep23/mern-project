              ...
              <div className="fixed inset-0 top-[calc(66px)] z-10 flex flex-col dark:bg-black/50 bg-white/ px-4 pb-[86px] pt-4 sm:top-[calc(82px)] sm:px-14 sm:py-8">
                ...
                >
                  ...
                  <div className="flex flex-col items-center text-center justify-center mb-3">
                    ...
                    {subtitle && (
                      <span className=" text-lg dark:text-gray-300 text-zinc-400  ">
                        {subtitle}
                      </span>
                    )}
                    {message && (
                      <span className=" text-lg text-gray-300 mt-3">
                        {message}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    ...
                    <button
                      ...
                      className={`${
                        critical
                          ? "dark:bg-[#212121] dark:text-red-500 bg-red-500 text-white "
