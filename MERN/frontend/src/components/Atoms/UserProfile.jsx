...
import { formatSubscription } from "../../helpers/formatFig";
import { toggleSubscription } from "../../store/Slices/subscription";
    ...
    <div className="mt-4 flex items-center justify-between">
      ...
      >
        <button
          className={`group/btn mr-1 flex w-full items-center gap-x-2 ${
            profileData?.isSubscribed
              ? "dark:bg-[#ae7aff] bg-red-500 "
              : "dark:bg-white bg-red-100 "
        ...
        >
          ...
          <span
            className={` ${profileData?.isSubscribed ? "hidden " : "block "}`}
          >
            Subscribe
          </span>
          <span
            className={`${profileData?.isSubscribed ? "block " : "hidden "}`}
          >
            Subscribed
          </span>
        </button>
