  ...
  return !playlist ? (
    ...
    <div className="grid gap-4 pt-2 sm:grid-cols-[repeat(auto-fit,_minmax(400px,_1fr))]">
      ...
      <div className="w-full">
        ...
        <p className="flex text-sm text-gray-200">
          Learn the core concepts and fundamentals of JavaScript programming
          language.
        </p>
      </div>
      <div className="w-full">
        ...
        <p className="flex text-sm text-gray-200">
          Dive into TypeScript for enhanced type safety and scalable JavaScript
          applications.
        </p>
      </div>
      <div className="w-full">
      ...
      <div className="w-full">
        ...
        <p className="flex text-sm text-gray-200">
          Delve into advanced JavaScript concepts and techniques for
